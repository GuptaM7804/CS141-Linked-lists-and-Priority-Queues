...
// pq_prio_index
//
// Searches list for the index where the data set should be inserted, returns the value of that point
// *Doesn't need a check for how many values the list has as this function is used in another function
//
